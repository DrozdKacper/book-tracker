...
@Component
public class MostReviewedBooksStrategy implements BookFilterStrategy{

    private final ReviewRepository reviewRepository;

    @Autowired
    public MostReviewedBooksStrategy(ReviewRepository reviewRepository) {
        this.reviewRepository = reviewRepository;
    }

    @Override
     public Page<BookListItemDto> filterBooks(Pageable pageable) {
        return reviewRepository.findAllOrderByReviewCountDesc(pageable);
    }
}
