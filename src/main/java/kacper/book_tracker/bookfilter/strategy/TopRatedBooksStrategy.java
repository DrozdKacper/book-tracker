...
@Component
public class TopRatedBooksStrategy implements BookFilterStrategy{

    private final ReviewRepository reviewRepository;

    @Autowired
    public TopRatedBooksStrategy(ReviewRepository reviewRepository) {
    ...
    public Page<BookListItemDto> filterBooks(Pageable pageable) {
        return reviewRepository.findAllOrderByAverageRatingDesc(pageable);
    }
}
